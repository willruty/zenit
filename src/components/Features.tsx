      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Por que escolher a Zenit?
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Soluções inteligentes que aceleram seu crescimento digital com segurança e inovação.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Tecnologia de IA automatiza processos, garantindo sites prontos em tempo recorde."
            index={0}
          />
          <FeatureCard
            ...
            description="Cada site é adaptado às necessidades específicas do seu negócio e público."
            index={1}
          />
          <FeatureCard
            ...
            title="Alta Precisão"
            description="Nossa IA assegura que todos os detalhes estejam corretos e otimizados."
            index={2}
          />
          <FeatureCard
            ...
            title="Suporte Ágil"
            description="Equipe dedicada responde rápido e mantém seu site atualizado e seguro."
            index={3}
          />
          <FeatureCard
            ...
            description="Protocolos avançados protegem seus dados e a privacidade dos usuários."
            index={4}
          />
          <FeatureCard
            ...
            description="Acompanhamos tendências e tecnologias para manter seu site sempre moderno."
            index={5}
          />
        </div>
      </div>
