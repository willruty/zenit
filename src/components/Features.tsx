      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Zenit is the highest point and that’s where we take your business with strategy and innovation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Fast Delivery"
            description="AI-driven automation ensures your website is ready in record time."
            index={0}
          />
          <FeatureCard
            ...
            description="Every website is tailored to your business needs and audience."
            index={1}
          />
          <FeatureCard
            ...
            description="Our AI ensures every detail is optimized for maximum performance."
            index={2}
          />
          <FeatureCard
            ...
            title="Agile Support"
            description="A dedicated team responds fast and keeps your site secure and updated."
            index={3}
          />
          <FeatureCard
            ...
            description="Advanced protocols protect your data and safeguard user privacy."
            index={4}
          />
          <FeatureCard
            ...
            description="We track trends and tech to keep your website always ahead."
            index={5}
          />
        </div>
      </div>
